...
resource "azurerm_network_security_group" "mul_nsg01" {
  name                = "${var.region_abbreviation}-mul${var.resource_version}-back01-nsg${local.suffix}"
  location            = var.azure_location
  resource_group_name = module.rg.name
...
resource "azurerm_network_security_group" "mul_nsg02" {
  name                = "${var.region_abbreviation}-mul${var.resource_version}-back02-nsg${local.suffix}"
  location            = var.azure_location
  resource_group_name = module.rg.name
...
resource "azurerm_network_security_group" "mul_nsg03" {
  name                = "${var.region_abbreviation}-mul${var.resource_version}-back03-nsg${local.suffix}"
  location            = var.azure_location
  resource_group_name = module.rg.name
...
resource "azurerm_network_security_group" "mul_nsg04" {
  name                = "${var.region_abbreviation}-mul${var.resource_version}-back04-nsg${local.suffix}"
  location            = var.azure_location
  resource_group_name = module.rg.name

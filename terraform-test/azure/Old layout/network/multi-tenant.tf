...
module "kusto" {
  ...
  kusto_sku_name                = "Standard_DS13_v2+1TB_PS"
  kusto_sku_capacity            = 2
  public_ip_name_for_engine     = local.kusto_engine_public_ip_name
  public_ip_name_for_management = local.kusto_management_public_ip_name

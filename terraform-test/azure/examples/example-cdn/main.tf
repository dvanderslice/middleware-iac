...
locals {
  ...
  storage_account_name = "${var.region_abbreviation}${var.purpose}${var.resource_version}${var.env_name}${var.env_key}sa${local.suffix}"
  cdn_profile_name     = "${var.region_abbreviation}-${var.purpose}${var.resource_version}-${var.env_name}${var.env_key}-cdn${local.suffix}"
